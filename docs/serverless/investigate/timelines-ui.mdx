...
by expanding the <DocLink slug="/serverless/security/timelines-ui" section="narrow-expand">query builder</DocLink> and clicking **+ Add field**.
...
<DocLink slug="/serverless/security/detection-engine-overview">detection rules</DocLink>. Timeline templates allow you to
...
retrieved from the alert. For more information, refer to <DocLink slug="/serverless/security/timeline-templates-ui">Create Timeline templates</DocLink>.
...
To further inspect an event or detection alert, click the **View details** button. A flyout with event or <DocLink slug="/serverless/security/view-alert-details">alert details</DocLink> appears.
...
When you convert a <DocLink slug="/serverless/security/timeline-templates-ui">Timeline template</DocLink> to a
Timeline, some fields may be disabled. For more information, refer to
<DocLink slug="/serverless/security/timeline-templates-ui" section="timeline-template-legend">Timeline template legend</DocLink>.
</DocCallOut>
...
To learn more about cases, refer to <DocLink slug="/serverless/security/cases-overview">Cases</DocLink>.
...
* **Create template from timeline** (refer to <DocLink slug="/serverless/security/timeline-templates-ui">Create Timeline templates</DocLink>)
* **Duplicate timeline**
* **Export selected** (refer to <DocLink slug="/serverless/security/timelines-ui" section="export-and-import-timelines">Export and import Timelines</DocLink>)
* **Delete selected**
...
- Write an ((esql)) query to explore your events. For example, start with the following query, then iterate on it to tailor your results: 
    ...
    ```
        ...
        - It starts by querying documents within the Security alert index (`.alerts-security.alerts-default`) and indices specified in the <DocLink slug="/serverless/security/advanced-settings" section="update-sec-indices">Security data view</DocLink>.
