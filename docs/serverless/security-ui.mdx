...
<DocImage size="xl" url="images/es-ui-overview/-getting-started-timeline-accessiblity-keyboard-focus-hotkeys.gif" alt="Demo that shows how to display an element menu" />
