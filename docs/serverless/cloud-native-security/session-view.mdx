...
To view Linux session data from your Kubernetes infrastructure, you'll need to set up the <DocLink slug="/serverless/security/kubernetes-dashboard-dash">Kubernetes dashboard</DocLink>.
</DocCallOut>
